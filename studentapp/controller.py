...
def nhap_diem():
    ...
    if request.method.__eq__('POST'):
        ...
        # print('value', value)
        student = dao.get_student_by_id_name(student_id=int(student_id),
                                             student_name=student_name)
        print('student from controller', student)
        ...
        if student:
            ...
            msg = 'Mã học sinh "{id}" với tên "{name}" không khớp vui lòng kiểm tra lại  '\
            .format(id=student_id, name=student_name)
        ...
        if class_id:
            ...
            if semester_object:
                ...
                marks = dao.get_mark_by_subject_and_class(semester_id=semester_id,
                                                          ...
                                                          class_id=class_id)
                mark_type = dao.get_mark_type_by_subject_and_class(semester_id=int(semester_id),
                                                                   subject_id=int(subject_id),
                                                                   class_id=int(class_id))
                print('mark_type from controller', mark_type)
            else:
